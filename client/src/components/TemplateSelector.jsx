...
const TemplateSelector = ({selectedTemplate, onChange}) => {
    ...
    const templates= [
   {
    id:'classic',
    name:'Classic',
    preview:"A clean tradational resume format with clear sections and professional typography"
   },

    {
    id:'modern',
    name:'Modern',
    preview:"Sleek design with stategic use of colors amd modern font choices"
   },
    {
    id:'minimal-image',
    name:'Minimal Image',
    ...
    id:'minimal',
    name:'Minimal',
    preview:"Ultra clean design that puts your content form front and center"
   },
  ...
  return (
    ...
    {templates.map((template)=>(
        <div key={template.id} onClick={()=>{onChange(template.id); setISOpen(false)}} 
         className={`relative p-3 border reounded-md cursor-pointer transition-all ${selectedTemplate === template.id ? "border-blue-300 bg-blue-100" : "border-gray-300 hover:border-gray-400 hover:bg-gray-100"}`}>
