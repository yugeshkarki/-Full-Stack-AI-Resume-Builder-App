  ...
  return (
   ...
   <div id='features' className='flex flex-col items-center my-10 scroll-mt-10'>
      <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 rounded-full px-6 py-1.5">
        ...
        <Title title="Don't just take our words" description='Hear what our user say about us.we are alawys looking for aways to improve.if you have positive experience with us, leave a review '/>
