...
const Features = () => {
  ...
  <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 rounded-full px-6 py-1.5">
        ...
        <Title title='Build your resume' description='Our streamlined process help you create a professionals resume in minute with inteligent AI-powered tools and features '/>
